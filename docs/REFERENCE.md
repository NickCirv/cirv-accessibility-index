# cirv-accessibility-index — implementation reference

Source revision: `068719ce5709f958d8ca2b9c9f022d15696fb4a8`. This reference records source declarations; it is not a transcript of a successful run.

## Entrypoint and runtime

[package.json](https://github.com/NickCirv/cirv-accessibility-index/blob/068719ce5709f958d8ca2b9c9f022d15696fb4a8/package.json) declares `bin/build-site.js`. Node.js `22.x` and npm.

## Supported workflow

Seeded crawler; SQLite history; static directory build; API keys and usage limits; separate liveness/readiness endpoints.
...
| --- | --- |
| `test` | `node test.js && node api/test.js` |
| `test:crawler` | `node test.js` |
...
[api/server.js](https://github.com/NickCirv/cirv-accessibility-index/blob/068719ce5709f958d8ca2b9c9f022d15696fb4a8/api/server.js).
